...
rem openssl rsa -in iPhoneDeviceCA_private.key -out iPhoneDeviceCA_public.key -outform PEM -pubout -passin pass:icloud
openssl pkcs8 -in iPhoneDeviceCA_private.key -out iPhoneDeviceCA_private_decrypted.key -passin pass:icloud
